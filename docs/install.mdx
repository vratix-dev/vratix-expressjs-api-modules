...
To simplify setup and integration, we created a CLI tool to help you start new projects. 
It handles imports, configurations, and dependencies automatically, so you can get up and running in seconds.
